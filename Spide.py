...
# GURU - HTTP Unbearable Load King
...
def usage():
	...
	print 'USAGE: python Spide.py <url www.kuxbhi.com>'
...
def httpcall(url):
	...
	try:
			...
			print 'DDoS 1010100000111 Runing Trafic Web code 10000'
	...
	def run(self):
		...
		while flag==0:
			...
			if (previous+100<request_counter) & (previous<>request_counter):
				...
				print "%d DDoS Error Requests Sending" % (request_counter)

				previous=request_counter

		if flag==2:

			print "\n-- SpideSec Attack Finished --"
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "--SpideSec DDoS Attack Started..........wait And and check server in Check Host.. --"
